...
SENSORS: tuple[M7SensorDesc, ...] = (
    ...
    M7SensorDesc(key="rx_speed", name="Download speed", path=("wan", "rxSpeed"), convert=_num, **_speed),
    M7SensorDesc(key="tx_speed", name="Upload speed", path=("wan", "txSpeed"), convert=_num, **_speed),
